package eu.omisoft.micro.common.dao;


import eu.omisoft.micro.common.entities.BaseEntity;
...
public abstract class BaseDAO<T extends BaseEntity> {
  ...
  public List<T> findAll() throws NotFoundException {
    ...
    if (found != null) {
      ...
      throw new NotFoundException(
              "Could not find all eu.omisoft.micro.common.entities from type: " + type.getSimpleName()
              + "\n" + q.toString());
    }
  }
  ...
  /**
   * Saves or updates all eu.omisoft.micro.common.entities from collection.
   *
  ...
  /**
   * Base method to get entity manager Use this to enable eu.omisoft.micro.common.filters
   */
